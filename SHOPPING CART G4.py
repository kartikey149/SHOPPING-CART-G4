...
class Shop:
    def __init__(self):
        self.products = [
            ...
            Product(2, "Smartphone", 18000),
            Product(3, "Headphones", 1500),
            Product(4, "Keyboard", 700),
            Product(5, "Wireless Mouse", 500),
            Product(6, "Monitor", 12000),
            Product(7, "USB-C Charger", 1300),
            Product(8, "External Hard Drive", 4500),
            Product(9, "Webcam", 2200),
            Product(10, "Bluetooth Speaker", 2500)
        ]
